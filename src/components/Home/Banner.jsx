        ...
        <div className="hero min-h-screen">
            <div className="hero-content flex-col lg:flex-row-reverse">
                ...
                <div className="w-full lg:w-3/5">
                    <h1 className="text-5xl font-bold"><span className="text-blue-800"> Effortlessly Manage all your tasks </span><span className="text-orange-500">at one Place</span><img src="https://raw.githubusercontent.com/SumonaShimu/images/main/add.gif" className="h-12 inline-block ms-5" /></h1>
